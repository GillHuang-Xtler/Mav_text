...
if __name__ =='__main__':
    ...
    # plt.plot(X1, label='Random', linewidth = '1')
    plt.plot(X2,  label='FedProx', linewidth = '1')
    plt.plot(X3, label='TiFL', linewidth='1')
    plt.plot(X4, label='FedFast', linewidth='1')
    plt.plot(X5,  label='svb', linewidth = '1')
    plt.plot(X6, label='FedEMD', linewidth = '1')
